...
基于 Java + Etcd + Vert.x + 自定义协议 的高性能 RPC 框架。可以学习并实践基于 Vert.x 的网络服务器、序列化器、基于 Etcd 和 ZooKeeper 的注册中心、反射、动态代理、自定义网络协议、多种设计模式（单例 / 工厂 / 装饰者等）、负载均衡器设计、重试和容错机制、Spring Boot Starter 注解驱动开发等，大幅提升架构设计能力。

> Github:https://github.com/1429222731/My-RPC
>
> Gitee:https://gitee.com/superman_cant_fly_Jay/my-rpc
